/**
 * 身价系统数据库迁移脚本 - 远程数据库版本
 * 运行方式: node scripts/migrate-value-system-remote.js
 */
...
async function migrate() {
  try {
    console.log(`连接远程数据库 ${DB_CONFIG.host}...`);
    ...
    const years = [
      { year: 11, name: '第11年', startDate: '2023-12-09', endDate: '2024-12-08', stayLine: 5000, isActive: 0 },
      { year: 12, name: '第12年', startDate: '2024-12-09', endDate: '2025-12-08', stayLine: 5000, isActive: 1 },
      { year: 13, name: '第13年', startDate: '2025-12-09', endDate: '2026-12-08', stayLine: 5000, isActive: 0 }
    ];
